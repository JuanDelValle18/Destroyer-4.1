	...
	if (!isWelcome) return
		try {
			...
			if (mem.action == 'add') {
				...
				try {
					ppimg = await client.getProfilePicture(https://static.wikia.nocookie.net/espokemon/images/b/b7/Icono_Pok%C3%A9mon_GO.png/revision/latest?cb=20160706232545)
				} catch {
